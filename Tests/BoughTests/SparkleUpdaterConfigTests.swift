...
final class SparkleUpdaterConfigTests: XCTestCase {
    ...
    func testStableVersionMetadata() throws {
        XCTAssertEqual(try plistExtract("CFBundleShortVersionString"), "1.1.0")
        XCTAssertEqual(try plistExtract("CFBundleVersion"), "8")
        XCTAssertEqual(try plistExtract("BoughReleaseLabel"), "1.1.0")
    }
