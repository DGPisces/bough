...
final class SparkleUpdaterConfigTests: XCTestCase {
    ...
    func testStableVersionMetadata() throws {
        XCTAssertEqual(try plistExtract("CFBundleShortVersionString"), "1.0.6")
        XCTAssertEqual(try plistExtract("CFBundleVersion"), "7")
        XCTAssertEqual(try plistExtract("BoughReleaseLabel"), "1.0.6")
    }
