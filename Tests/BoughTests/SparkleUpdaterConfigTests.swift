...
final class SparkleUpdaterConfigTests: XCTestCase {
    ...
    func testStableVersionMetadata() throws {
        XCTAssertEqual(try plistExtract("CFBundleShortVersionString"), "1.2.1")
        XCTAssertEqual(try plistExtract("CFBundleVersion"), "11")
        XCTAssertEqual(try plistExtract("BoughReleaseLabel"), "1.2.1")
    }
