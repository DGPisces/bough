// ============================================================
// bough-bridge — Native Claude Code hook event forwarder
// ============================================================
...
// • BOUGH_SKIP env var support
// • Debug logging (BOUGH_DEBUG)
// ============================================================
...
func connectSocket(_ path: String, timeoutMs: Int32 = 3000) -> Int32? {
    ...
    withUnsafeMutablePointer(to: &addr.sun_path.0) { ptr in
        path.withCString { _ = strlcpy(ptr, $0, maxSocketPathLength) }
    }
...
// Quick exit: skip if BOUGH_SKIP is set
guard env["BOUGH_SKIP"] == nil else { exit(0) }
